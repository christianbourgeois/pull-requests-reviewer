module.exports = {
  findPullRequests: function() {
    return [
      ...
      { title: "[RtM] TPMEU-1129, ZD-8460 Translate Bundles and remove swedish", id: 6079, labels: [], author: "yluron", nbNotifications: 10, url: "https://github.com/AppDirect/AppDirect/pull/6079" }
    ];
  },
